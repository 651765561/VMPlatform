...
namespace LeaRun.Repository
{
    ...
    public class Repository<T> : IRepository<T> where T : new()
    {
        ...
        public DataTable FindTableBySqlNoLower(string strSql)
        {
            return DataFactory.Database().FindTableBySqlNoLower(strSql);
        }
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        ...
        /// <param name="parameters">sql语句对应参数</param>
        /// <returns></returns>
        public DataTable FindTableBySqlNoLower(string strSql, DbParameter[] parameters)
        {
            return DataFactory.Database().FindTableBySqlNoLower(strSql, parameters);
        }
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
