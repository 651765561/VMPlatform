...
namespace LeaRun.Business
{
    ...
    /// </author>
    /// </summary>
    public class SaleControl_SendBll : RepositoryFactory<SaleControl_Send>
    {
        ...
        public string GetSale(string ParameterJson, JqGridParam jqgridparam)
        {
            ...
            try
            {
                ...
                sql = sql + " and om.state=0 and p.state=1";//商品未发放 and 在押
        ...
        //商品发放
        public int Send(string KeyValue)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Operation_Main set state=1 where operationmain_id in ("+ KeyValue+")");
