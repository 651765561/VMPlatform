...
{
    public partial class JW_BreakRoles_XJBll : RepositoryFactory<JW_BreakRoles>
    {
        /// <summary>
        /// 加载列表数据
        /// </summary>
...
union all
select Usedetail_id breakroles, ju.unit_id,ju.PoliceArea_id,apply_id,adduser_id,GETDATE() addDate,'' watchuser,ju.room_id,GETDATE() startdate,'办案超时' detail,'' treatement,u.unit unitName,bp.AreaName PoliceAreaName,bu.RealName adduserName  from JW_Usedetail  ju 
...
//left join Base_User bu on jb.adduser_id=bu.UserId {4}
//union all
//select Usedetail_id breakroles, ju.unit_id,ju.PoliceArea_id,apply_id,adduser_id,GETDATE() addDate,'' watchuser,ju.room_id,GETDATE() startdate,'办案超时' detail,'' treatement,u.unit unitName,bp.AreaName PoliceAreaName,bu.RealName adduserName,br.RoomName roomname  from JW_Usedetail  ju 
//left join Base_Unit u on ju.unit_id=u.Base_Unit_id 
//left join Base_PoliceArea bp on ju.PoliceArea_id=bp.PoliceArea_id 
