...
{
    public partial class JW_SecurityCheck_ZDJSBll : RepositoryFactory<JW_SecurityCheck>
    {
        /// <summary>
        /// 加载列表数据
        /// </summary>
        ...
        /// <returns></returns>
        public string GridPageSecurityCheck_ZDJSJson(string ParameterJson, string apply_id, JqGridParam jqgridparam)
        {
            try
            {
...
order by {2} {3} "
        ...
        /// <returns></returns>
        public int SubmitSecurityCheck_ZDJSForm(string submitType, JW_SecurityCheck jwSecurityCheck)
        {
            //先获取相关信息
...
");
        ...
        /// <returns></returns>
        public int DeleteSecurityCheck_ZDJS(string securitycheck_id, string user_id)
        {
            // start 取消不同法警互相删除的权限
