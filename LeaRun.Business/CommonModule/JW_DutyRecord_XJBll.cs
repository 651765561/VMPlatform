...
{
    public partial class JW_DutyRecord_XJBll : RepositoryFactory<JW_DutyRecord>
    {
        /// <summary>
        /// 加载列表数据
        /// </summary>
        ...
        public int SubmitDutyForm(string submitType, JW_DutyRecord jwDutyRecord)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        string sqlCheckEidt = string.Format(@" select * from JW_DutyRecord where dutyrecord_id='{0}' and adduser_id='{1}' "
