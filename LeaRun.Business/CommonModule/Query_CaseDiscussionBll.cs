...
{
 public   class Query_CaseDiscussionBll : RepositoryFactory<Base_Meeting>
    {
                ...
                string sqlTotal =
                     string.Format(
                         @" 
                                       ...
                                       where m.type=2   and m.unit_id='{0}' "
                ...
                string sqlTotal =
                  string.Format(
                     @" 
                                          ...
                                          FROM      Base_Meeting m
                                                    LEFT JOIN Base_Unit c ON c.Base_Unit_id = m.Unit_id
                                                    LEFT JOIN Base_User u ON u.UserId = m.adduser_id where  m.type=2
                                           ");
